...
app.use("/add-new-caravan", (req, res) => {
    res.send(`
        <div style="margin-top:100px; display:flex; flex-direction:column; align-items:center">
            <h1 style="text-align:center">ADD new 'caravan'</h1>
            <form action="/caravan" method="POST" style="background-color: #f2f2f2; display: flex; flex-direction: column; gap: 20px; width: 400px; padding: 20px; ">
